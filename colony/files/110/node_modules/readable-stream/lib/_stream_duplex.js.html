...
require(<span class="string">'inherits'</span>)(Duplex, Readable);

{
  <span class="comment">// Allow the keys array to be GC'ed.</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">Duplex</span><span class="params">(options)</span> {</span>
  ...
  <span class="keyword">if</span> (options) {
    <span class="keyword">if</span> (options.readable === <span class="literal">false</span>) <span class="keyword">this</span>.readable = <span class="literal">false</span>;
    <span class="keyword">if</span> (options.writable === <span class="literal">false</span>) <span class="keyword">this</span>.writable = <span class="literal">false</span>;

    <span class="keyword">if</span> (options.allowHalfOpen === <span class="literal">false</span>) {
      <span class="keyword">this</span>.allowHalfOpen = <span class="literal">false</span>;
...
Object.defineProperty(Duplex.prototype, <span class="string">'writableBuffer'</span>, {
  <span class="comment">// making it explicit this property is not enumerable</span>
  <span class="comment">// because otherwise some prototype manipulation in</span>
  <span class="comment">// userland will fail</span>
  enumerable: <span class="literal">false</span>,
...
Object.defineProperty(Duplex.prototype, <span class="string">'writableLength'</span>, {
  <span class="comment">// making it explicit this property is not enumerable</span>
  <span class="comment">// because otherwise some prototype manipulation in</span>
  <span class="comment">// userland will fail</span>
  enumerable: <span class="literal">false</span>,
...
<span class="function"><span class="keyword">function</span> <span class="title">onend</span><span class="params">()</span> {</span>
  <span class="comment">// If the writable side ended, then we're ok.</span>
  <span class="keyword">if</span> (<span class="keyword">this</span>._writableState.ended) <span class="keyword">return</span>; <span class="comment">// no more data can be written.</span>
  <span class="comment">// But allow more writes to happen in this tick.</span>

  process.nextTick(onEndNT, <span class="keyword">this</span>);
}
