...
require(<span class="string">'inherits'</span>)(Transform, Duplex);
...
<span class="function"><span class="keyword">function</span> <span class="title">afterTransform</span><span class="params">(er, data)</span> {</span>
  ...
  <span class="keyword">if</span> (cb === <span class="literal">null</span>) {
    <span class="keyword">return</span> <span class="keyword">this</span>.emit(<span class="string">'error'</span>, <span class="keyword">new</span> ERR_MULTIPLE_CALLBACK());
  }
...
<span class="function"><span class="keyword">function</span> <span class="title">Transform</span><span class="params">(options)</span> {</span>
  ...
  <span class="keyword">this</span>._readableState.needReadable = <span class="literal">true</span>; <span class="comment">// we have implemented the _read method, and done the other things</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">prefinish</span><span class="params">()</span> {</span>
  ...
  <span class="keyword">if</span> (<span class="keyword">typeof</span> <span class="keyword">this</span>._flush === <span class="string">'function'</span> &amp;&amp; !<span class="keyword">this</span>._readableState.destroyed) {
...
Transform.prototype._transform = <span class="function"><span class="keyword">function</span> <span class="params">(chunk, encoding, cb)</span> {</span>
  cb(<span class="keyword">new</span> ERR_METHOD_NOT_IMPLEMENTED(<span class="string">'_transform()'</span>));
};
...
Transform.prototype._read = <span class="function"><span class="keyword">function</span> <span class="params">(n)</span> {</span>
  ...
  <span class="keyword">if</span> (ts.writechunk !== <span class="literal">null</span> &amp;&amp; !ts.transforming) {
...
<span class="function"><span class="keyword">function</span> <span class="title">done</span><span class="params">(stream, er, data)</span> {</span>
  ...
  <span class="keyword">if</span> (data != <span class="literal">null</span>) <span class="comment">// single equals check for both `null` and `undefined`</span>
    stream.push(data); <span class="comment">// TODO(BridgeAR): Write a test for these two error cases</span>
  ...
  <span class="keyword">if</span> (stream._writableState.length) <span class="keyword">throw</span> <span class="keyword">new</span> ERR_TRANSFORM_WITH_LENGTH_0();
  <span class="keyword">if</span> (stream._transformState.transforming) <span class="keyword">throw</span> <span class="keyword">new</span> ERR_TRANSFORM_ALREADY_TRANSFORMING();
