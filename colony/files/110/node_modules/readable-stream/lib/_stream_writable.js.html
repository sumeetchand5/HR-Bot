...
require(<span class="string">'inherits'</span>)(Writable, Stream);

<span class="function"><span class="keyword">function</span> <span class="title">nop</span><span class="params">()</span> {</span>}

<span class="function"><span class="keyword">function</span> <span class="title">WritableState</span><span class="params">(options, stream, isDuplex)</span> {</span>
  ...
  <span class="comment">// e.g. options.readableObjectMode vs. options.writableObjectMode, etc.</span>

  <span class="keyword">if</span> (<span class="keyword">typeof</span> isDuplex !== <span class="string">'boolean'</span>) isDuplex = stream <span class="keyword">instanceof</span> Duplex; <span class="comment">// object stream flag to indicate whether or not this stream</span>
  <span class="comment">// contains buffers or objects.</span>

  <span class="keyword">this</span>.objectMode = !!options.objectMode;
  <span class="keyword">if</span> (isDuplex) <span class="keyword">this</span>.objectMode = <span class="keyword">this</span>.objectMode || !!options.writableObjectMode; <span class="comment">// the point at which write() starts returning false</span>
  ...
  <span class="keyword">this</span>.highWaterMark = getHighWaterMark(<span class="keyword">this</span>, options, <span class="string">'writableHighWaterMark'</span>, isDuplex); <span class="comment">// if _final has been called</span>

  <span class="keyword">this</span>.finalCalled = <span class="literal">false</span>; <span class="comment">// drain event flag.</span>

  <span class="keyword">this</span>.needDrain = <span class="literal">false</span>; <span class="comment">// at the start of calling end()</span>

  <span class="keyword">this</span>.ending = <span class="literal">false</span>; <span class="comment">// when end() has been called, and returned</span>

  <span class="keyword">this</span>.ended = <span class="literal">false</span>; <span class="comment">// when 'finish' is emitted</span>

  <span class="keyword">this</span>.finished = <span class="literal">false</span>; <span class="comment">// has it been destroyed</span>

  <span class="keyword">this</span>.destroyed = <span class="literal">false</span>; <span class="comment">// should we decode strings into buffers before passing to _write?</span>
  ...
  <span class="keyword">this</span>.decodeStrings = !noDecode; <span class="comment">// Crypto is kind of old and crusty.  Historically, its default string</span>
  ...
  <span class="keyword">this</span>.defaultEncoding = options.defaultEncoding || <span class="string">'utf8'</span>; <span class="comment">// not an actual buffer we keep track of, but a measurement</span>
  <span class="comment">// of how much we're waiting to get pushed to some underlying</span>
  <span class="comment">// socket or file.</span>

  <span class="keyword">this</span>.length = <span class="number">0</span>; <span class="comment">// a flag to see when we're in the middle of a write.</span>

  <span class="keyword">this</span>.writing = <span class="literal">false</span>; <span class="comment">// when true all writes will be buffered until .uncork() call</span>

  <span class="keyword">this</span>.corked = <span class="number">0</span>; <span class="comment">// a flag to be able to tell if the onwrite cb is called immediately,</span>
  ...
  <span class="keyword">this</span>.sync = <span class="literal">true</span>; <span class="comment">// a flag to know if we're processing previously buffered items, which</span>
  ...
  <span class="keyword">this</span>.bufferProcessing = <span class="literal">false</span>; <span class="comment">// the callback that's passed to _write(chunk,cb)</span>
  ...
  <span class="keyword">this</span>.writecb = <span class="literal">null</span>; <span class="comment">// the amount that is being written when _write is called.</span>
  ...
  <span class="keyword">this</span>.lastBufferedRequest = <span class="literal">null</span>; <span class="comment">// number of pending user-supplied write callbacks</span>
  <span class="comment">// this must be 0 before 'finish' can be emitted</span>

  <span class="keyword">this</span>.pendingcb = <span class="number">0</span>; <span class="comment">// emit prefinish if the only thing we're waiting for is _write cbs</span>
  <span class="comment">// This is relevant for synchronous Transform streams</span>

  <span class="keyword">this</span>.prefinished = <span class="literal">false</span>; <span class="comment">// True if the error was already emitted and should not be thrown again</span>

  <span class="keyword">this</span>.errorEmitted = <span class="literal">false</span>; <span class="comment">// Should close be emitted on destroy. Defaults to true.</span>

  <span class="keyword">this</span>.emitClose = options.emitClose !== <span class="literal">false</span>; <span class="comment">// count buffered requests</span>

  <span class="keyword">this</span>.bufferedRequestCount = <span class="number">0</span>; <span class="comment">// allocate the first CorkedRequest, there is always</span>
...
(<span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
  <span class="keyword">try</span> {
    Object.defineProperty(WritableState.prototype, <span class="string">'buffer'</span>, {
      get: internalUtil.deprecate(<span class="function"><span class="keyword">function</span> <span class="title">writableStateBufferGetter</span><span class="params">()</span> {</span>
...
<span class="keyword">if</span> (<span class="keyword">typeof</span> Symbol === <span class="string">'function'</span> &amp;&amp; Symbol.hasInstance &amp;&amp; <span class="keyword">typeof</span> Function.prototype[Symbol.hasInstance] === <span class="string">'function'</span>) {
  ...
  Object.defineProperty(Writable, Symbol.hasInstance, {
    value: <span class="function"><span class="keyword">function</span> <span class="title">value</span><span class="params">(object)</span> {</span>
  ...
  realHasInstance = <span class="function"><span class="keyword">function</span> <span class="title">realHasInstance</span><span class="params">(object)</span> {</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">Writable</span><span class="params">(options)</span> {</span>
  Duplex = Duplex || require(<span class="string">'./_stream_duplex'</span>); <span class="comment">// Writable ctor is applied to Duplexes, too.</span>
  ...
  <span class="comment">// Checking for a Stream.Duplex instance is faster here instead of inside</span>
  <span class="comment">// the WritableState constructor, at least with V8 6.5</span>

  <span class="keyword">var</span> isDuplex = <span class="keyword">this</span> <span class="keyword">instanceof</span> Duplex;
  <span class="keyword">if</span> (!isDuplex &amp;&amp; !realHasInstance.call(Writable, <span class="keyword">this</span>)) <span class="keyword">return</span> <span class="keyword">new</span> Writable(options);
  <span class="keyword">this</span>._writableState = <span class="keyword">new</span> WritableState(options, <span class="keyword">this</span>, isDuplex); <span class="comment">// legacy.</span>
...
Writable.prototype.pipe = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
  <span class="keyword">this</span>.emit(<span class="string">'error'</span>, <span class="keyword">new</span> ERR_STREAM_CANNOT_PIPE());
};
...
<span class="function"><span class="keyword">function</span> <span class="title">writeAfterEnd</span><span class="params">(stream, cb)</span> {</span>
  <span class="keyword">var</span> er = <span class="keyword">new</span> ERR_STREAM_WRITE_AFTER_END(); <span class="comment">// TODO: defer error events consistently everywhere, not just the cb</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">validChunk</span><span class="params">(stream, state, chunk, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (chunk === <span class="literal">null</span>) {
    er = <span class="keyword">new</span> ERR_STREAM_NULL_VALUES();
  } <span class="keyword">else</span> <span class="keyword">if</span> (<span class="keyword">typeof</span> chunk !== <span class="string">'string'</span> &amp;&amp; !state.objectMode) {
    er = <span class="keyword">new</span> ERR_INVALID_ARG_TYPE(<span class="string">'chunk'</span>, [<span class="string">'string'</span>, <span class="string">'Buffer'</span>], chunk);
  }
...
Writable.prototype.write = <span class="function"><span class="keyword">function</span> <span class="params">(chunk, encoding, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (state.ending) writeAfterEnd(<span class="keyword">this</span>, cb);<span class="keyword">else</span> <span class="keyword">if</span> (isBuf || validChunk(<span class="keyword">this</span>, state, chunk, cb)) {
    state.pendingcb++;
...
Writable.prototype.cork = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
  <span class="keyword">this</span>._writableState.corked++;
};
...
Writable.prototype.uncork = <span class="function"><span class="keyword">function</span> <span class="params">()</span> {</span>
  ...
  <span class="keyword">if</span> (state.corked) {
    state.corked--;
    <span class="keyword">if</span> (!state.writing &amp;&amp; !state.corked &amp;&amp; !state.bufferProcessing &amp;&amp; state.bufferedRequest) clearBuffer(<span class="keyword">this</span>, state);
  }
};
...
Writable.prototype.setDefaultEncoding = <span class="function"><span class="keyword">function</span> <span class="title">setDefaultEncoding</span><span class="params">(encoding)</span> {</span>
  ...
  <span class="keyword">if</span> (!([<span class="string">'hex'</span>, <span class="string">'utf8'</span>, <span class="string">'utf-8'</span>, <span class="string">'ascii'</span>, <span class="string">'binary'</span>, <span class="string">'base64'</span>, <span class="string">'ucs2'</span>, <span class="string">'ucs-2'</span>, <span class="string">'utf16le'</span>, <span class="string">'utf-16le'</span>, <span class="string">'raw'</span>].indexOf((encoding + <span class="string">''</span>).toLowerCase()) > -<span class="number">1</span>)) <span class="keyword">throw</span> <span class="keyword">new</span> ERR_UNKNOWN_ENCODING(encoding);
  <span class="keyword">this</span>._writableState.defaultEncoding = encoding;
  <span class="keyword">return</span> <span class="keyword">this</span>;
};

Object.defineProperty(Writable.prototype, <span class="string">'writableBuffer'</span>, {
  ...
  get: <span class="function"><span class="keyword">function</span> <span class="title">get</span><span class="params">()</span> {</span>
    <span class="keyword">return</span> <span class="keyword">this</span>._writableState &amp;&amp; <span class="keyword">this</span>._writableState.getBuffer();
  }
});
...
<span class="function"><span class="keyword">function</span> <span class="title">writeOrBuffer</span><span class="params">(stream, state, isBuf, chunk, encoding, cb)</span> {</span>
  ...
  state.length += len;
  <span class="keyword">var</span> ret = state.length &lt; state.highWaterMark; <span class="comment">// we must ensure that previous needDrain will not be reset to false.</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">doWrite</span><span class="params">(stream, state, writev, len, chunk, encoding, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (state.destroyed) state.onwrite(<span class="keyword">new</span> ERR_STREAM_DESTROYED(<span class="string">'write'</span>));<span class="keyword">else</span> <span class="keyword">if</span> (writev) stream._writev(chunk, state.onwrite);<span class="keyword">else</span> stream._write(chunk, encoding, state.onwrite);
...
<span class="function"><span class="keyword">function</span> <span class="title">onwriteError</span><span class="params">(stream, state, sync, er, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (sync) {
    ...
    process.nextTick(cb, er); <span class="comment">// this can emit finish, and it will always happen</span>
    ...
    cb(er);
    stream._writableState.errorEmitted = <span class="literal">true</span>;
    stream.emit(<span class="string">'error'</span>, er); <span class="comment">// this can emit finish, but finish must</span>
...
<span class="function"><span class="keyword">function</span> <span class="title">onwrite</span><span class="params">(stream, er)</span> {</span>
  ...
  <span class="keyword">if</span> (<span class="keyword">typeof</span> cb !== <span class="string">'function'</span>) <span class="keyword">throw</span> <span class="keyword">new</span> ERR_MULTIPLE_CALLBACK();
  ...
  <span class="keyword">if</span> (er) onwriteError(stream, state, sync, er, cb);<span class="keyword">else</span> {
    ...
    <span class="keyword">var</span> finished = needFinish(state) || stream.destroyed;
...
<span class="function"><span class="keyword">function</span> <span class="title">clearBuffer</span><span class="params">(stream, state)</span> {</span>
  ...
  <span class="keyword">if</span> (stream._writev &amp;&amp; entry &amp;&amp; entry.next) {
    ...
    doWrite(stream, state, <span class="literal">true</span>, state.length, buffer, <span class="string">''</span>, holder.finish); <span class="comment">// doWrite is almost always async, defer these to save a bit of time</span>
    ...
    <span class="keyword">while</span> (entry) {
      ...
      doWrite(stream, state, <span class="literal">false</span>, len, chunk, encoding, cb);
      entry = entry.next;
      state.bufferedRequestCount--; <span class="comment">// if we didn't call the onwrite immediately, then</span>
...
Writable.prototype._write = <span class="function"><span class="keyword">function</span> <span class="params">(chunk, encoding, cb)</span> {</span>
  cb(<span class="keyword">new</span> ERR_METHOD_NOT_IMPLEMENTED(<span class="string">'_write()'</span>));
};
...
Writable.prototype.end = <span class="function"><span class="keyword">function</span> <span class="params">(chunk, encoding, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (chunk !== <span class="literal">null</span> &amp;&amp; chunk !== <span class="literal">undefined</span>) <span class="keyword">this</span>.write(chunk, encoding); <span class="comment">// .end() fully uncorks</span>
  ...
  <span class="keyword">if</span> (!state.ending) endWritable(<span class="keyword">this</span>, state, cb);
  <span class="keyword">return</span> <span class="keyword">this</span>;
};

Object.defineProperty(Writable.prototype, <span class="string">'writableLength'</span>, {
  <span class="comment">// making it explicit this property is not enumerable</span>
  <span class="comment">// because otherwise some prototype manipulation in</span>
  <span class="comment">// userland will fail</span>
  enumerable: <span class="literal">false</span>,
  get: <span class="function"><span class="keyword">function</span> <span class="title">get</span><span class="params">()</span> {</span>
    <span class="keyword">return</span> <span class="keyword">this</span>._writableState.length;
  }
});
...
<span class="function"><span class="keyword">function</span> <span class="title">prefinish</span><span class="params">(stream, state)</span> {</span>
  <span class="keyword">if</span> (!state.prefinished &amp;&amp; !state.finalCalled) {
    <span class="keyword">if</span> (<span class="keyword">typeof</span> stream._final === <span class="string">'function'</span> &amp;&amp; !state.destroyed) {
      state.pendingcb++;
...
<span class="function"><span class="keyword">function</span> <span class="title">endWritable</span><span class="params">(stream, state, cb)</span> {</span>
  ...
  <span class="keyword">if</span> (cb) {
    <span class="keyword">if</span> (state.finished) process.nextTick(cb);<span class="keyword">else</span> stream.once(<span class="string">'finish'</span>, cb);
  }
...
<span class="function"><span class="keyword">function</span> <span class="title">onCorkedFinish</span><span class="params">(corkReq, state, err)</span> {</span>
  ...
  <span class="keyword">while</span> (entry) {
    ...
    cb(err);
    entry = entry.next;
  } <span class="comment">// reuse the free corkReq.</span>
