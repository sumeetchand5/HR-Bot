...
<span class="comment">// a passthrough stream.</span>
<span class="comment">// basically just the most minimal sort of Transform stream.</span>
<span class="comment">// Every written chunk gets output as-is.</span>
<span class="string">'use strict'</span>;

module.exports = PassThrough;

<span class="keyword">var</span> Transform = require(<span class="string">'./_stream_transform'</span>);

require(<span class="string">'inherits'</span>)(PassThrough, Transform);

<span class="function"><span class="keyword">function</span> <span class="title">PassThrough</span><span class="params">(options)</span> {</span>
  <span class="keyword">if</span> (!(<span class="keyword">this</span> <span class="keyword">instanceof</span> PassThrough)) <span class="keyword">return</span> <span class="keyword">new</span> PassThrough(options);
  Transform.call(<span class="keyword">this</span>, options);
}

PassThrough.prototype._transform = <span class="function"><span class="keyword">function</span> <span class="params">(chunk, encoding, cb)</span> {</span>
  cb(<span class="literal">null</span>, chunk);
};</code></pre>